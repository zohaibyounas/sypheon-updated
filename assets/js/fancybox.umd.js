  ...
  class k extends g {
    ...
    startDecelAnim() {
      ...
      if (r > 0) {
        (h = Math.abs(o) > 3 ? o / (r / 30) : 0),
          (d = Math.abs(a) > 3 ? a / (r / 30) : 0);
        const t = this.option("maxVelocity");
        t &&
          ((h = Math.max(Math.min(h, t), -1 * t)),
    ...
    updateMetrics(t = !1) {
      ...
      f.style.setProperty("transform", "none", "important"),
        s && ((f.style.width = ""), (f.style.height = "")),
        f.offsetHeight;
  ...
  class G extends g {
    ...
    getSlideMetrics(t) {
      ...
      let n = 0,
        ...
        o = t.el;
      o
        ? (n = parseFloat(o.dataset[i] || "") || 0)
        : ((o = document.createElement("div")),
          (o.style.visibility = "hidden"),
          P(o, this.cn("slide") + " " + t.class),
          (this.track || document.body).prepend(o)),
        n
          ? ((o.style[i] = `${n}px`),
            (o.style["width" === i ? "height" : "width"] = ""))
          : (n = o.getBoundingClientRect()[i]);
      const a = getComputedStyle(o);
      return (
        "content-box" === a.boxSizing &&
          (this.isHorizontal
            ? ((n += parseFloat(a.paddingLeft) || 0),
              (n += parseFloat(a.paddingRight) || 0))
            : ((n += parseFloat(a.paddingTop) || 0),
              (n += parseFloat(a.paddingBottom) || 0))),
        (s =
    ...
    repositionSlides() {
      let t,
        ...
        h = 0;
      this.panzoom
        ? (h = -1 * this.panzoom.current[this.axis])
        : a[o] && (h = a[o].pos || 0),
        (t = this.isHorizontal ? (this.isRTL ? "right" : "left") : "top"),
        this.isRTL && this.isHorizontal && (h *= -1);
      ...
      if (this.isInfinite && c && i) {
        ...
        for (const i of this.slides)
          i.el &&
            (e(i.pos) < e(n) &&
              e(i.pos + i.dim + i.gap) < e(h) &&
              e(h) > e(s - n) &&
              (i.el.style[t] = `${e(l + c, 1e3)}px`),
            e(i.pos + i.gap) >= e(s - n) &&
              e(i.pos) > e(h + n) &&
              e(h) < e(n) &&
              (i.el.style[t] = `-${e(c, 1e3)}px`));
      }
      let d,
        u,
        p = [...this.inTransition];
        ...
        for (const n of this.slides)
          n.el
            ? this.inTransition.has(n.index) &&
              d.slides.indexOf(n) < 0 &&
              (n.el.style[t] = `${e(i + (d.pos - u.pos), 1e3)}px`)
            : (i += n.dim + n.gap);
      }
    }
    createSlideEl(t) {
    ...
    updateMetrics() {
      ...
      if (i) {
        let t = e(i.getBoundingClientRect()[o], 1e3),
          ...
          a = "padding",
          r = s ? "Right" : "Bottom";
        (t -= parseFloat(n[a + (s ? "Left" : "Top")]) + parseFloat(n[a + r])),
          (this.viewportDim = t);
      }
      let a,
        r = this.pages.length,
      ...
      for (const [t, i] of this.slides.entries()) {
        ...
        !i.el && a
          ? ((n = a.dim), (s = a.gap))
          : (({ dim: n, gap: s } = this.getSlideMetrics(i)), (a = i)),
          (n = e(n, 1e3)),
          (s = e(s, 1e3)),
          (i.dim = n),
          (i.gap = s),
      ...
      (l = e(l, 1e3)),
        ...
        t &&
          ((t.contentRect[o] = l),
          (t.contentRect["e" === this.axis ? "fullWidth" : "fullHeight"] = l)),
  ...
  class rt extends _ {
    ...
    onClose() {
      ...
      (this.instance.state = it.CustomClosing),
        e.classList.remove("is-zooming-in"),
        e.classList.add("is-zooming-out"),
    ...
    getZoomInfo(t) {
      ...
      return (
        "auto" === b && (b = Math.abs(r / l - d / u) > 0.1),
        { x: m, y: g, scale: p, opacity: b }
      );
    }
    attach() {
      this.instance.on("Carousel.change", this.onChange),
  ...
  let gt = class extends _ {
    ...
    attach() {
      ...
      t.on("initSlide", this.onInitSlide),
        t.state === j.Init
          ? t.on("initSlides", this.onInitSlides)
          : this.onInitSlides(),
    ...
    detach() {
      const { instance: t } = this;
      t.off("initSlide", this.onInitSlide),
        t.off("initSlides", this.onInitSlides),
        t.off("Panzoom.afterTransform", this.onTransformM),
        t.off("Panzoom.refresh", this.onRefreshM),
        t.off("change", this.onChangeM),
        this.cleanup();
    }
  };
      ...
      const n = this.container,
        ...
        a =
          o && this.option("placeFocusBack")
            ? o.triggerEl || this.option("trigger")
            : null;
      if (
        (a && (U(a) ? tt(a) : a.focus()),
        n &&
        ...
        for (const t of s.slides) {
          ...
          i && (i.stop(), i.detachEvents(), i.detachObserver()),
            this.isCurrentSlide(t) || s.emit("removeSlide", t);
        }
      }
      this.emit("close", t),
